...
# Preparing the data
data <- read_excel("/Users/valeriasimonelli/Desktop/PostDoc/Research/Foraging_Volatilitity/Adults/PulizieDiPrimavera/df_viol_next.xlsx")
...
g <- ggplot() +
  ...
  labs(
    x = "block",
    y = "good boxes rule violation next trial"
  ) +
  theme_classic()
...
# save the plot
ggsave(
  filename = "/Users/valeriasimonelli/Desktop/PostDoc/Research/Foraging_Volatilitity/Adults/Analisi_R/RuleViolation/goodboxes_ruleviolationnext_AQ.png",
  plot = g,
  width = 8,
  height = 6,
  dpi = 300
...
# save the plot
ggsave(
  filename = "/Users/valeriasimonelli/Desktop/PostDoc/Research/Foraging_Volatilitity/Adults/Analisi_R/RuleViolation/boxestotal_ruleviolationnext_AQ.png.png",
  plot = g,
  width = 8,
  height = 6,
  dpi = 300
